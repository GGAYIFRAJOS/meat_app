<?php 
  ...
  $sql = "SELECT * FROM abattoir_records JOIN animal ON abattoir_records.animal_id = animal.id JOIN abattoirs ON abattoir_records.abattoir_id = abattoirs.id JOIN farm ON animal.farm_id = farm.id JOIN village ON farm.village_id = village.id JOIN parish ON village.parish_id = parish.id JOIN subcounty ON parish.subcounty_id = subcounty.id JOIN districts ON subcounty.district_id  = districts.id  WHERE district_id = '$district_id'";
