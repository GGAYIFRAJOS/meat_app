...
<div class="app-main__outer">
                        ...
                        <div class="app-page-title">
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    ...
                                    <div><b>ADD INSURANCE REQUESTS</b>
 ...
 <div class="container" style="width: 60%;">
	...
	<form style="padding-top: 20px;" method="POST" action="add_insurance_request.php" enctype="multipart/form-data">
	  ...
	  <div class="form-group">
	    <label for="insurance_type"><address> Insurance Type</address></label>
