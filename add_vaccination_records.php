<?php 
  ...
  if(isset($_POST['animal_id'])){
    ...
    $vaccine_applied = $_POST['vaccine_applied'];

    $description = $_POST['description'];

    $sql = "INSERT INTO vaccination_history (animal_id, officer_id, disease, vaccine_applied, description)
    VALUES ('$animal_id', '$officer_id', '$disease', '$vaccine_applied', '$description')";
...
<div class="app-main__outer">
 ...
 <div class="container" style="width: 60%;">
  ...
  <div class="form-group">
    ...
    <div class="form-group">
      <label for="vaccine_applied"><address>Vaccine Applied</address></label>
      <input type="text" class="form-control" id="vaccine_applied" name="vaccine_applied">
    </div>
